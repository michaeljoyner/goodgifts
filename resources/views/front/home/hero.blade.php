<section class="db flex-ns justify-between-ns pv4">
    <div class="w-40-m w-50-l flex db-ns justify-center items-center">
        <img src="/images/logos/ggfg_logo_seethrough.png"
             alt="Goodgiftsforguys logo" class="db w-50 w6-ns mb5">
    </div>
    <div class="mw6 w-60-m w-50-l mh3 center-ns overflow-hidden">
        ...
        <p class="lh-copy measure strong-font f5 f4-ns col-gr ph2 ph0-ns tc tl-ns">Get a list of great gift ideas, based on his interests and your budget, right now or when you need it most.</p>
